    ...
    <div class="row">
      <div class="col-md-12"> 
        ...
        <header class="welcome-message text-center">
          <h1><span class="rotate">Ghana SHS Database, It's easy to Use, Just type Your Query! </span></h1>
        </header>
        <!--welcome-message end--> 
            ...
            <div class="col-md-5 center-block col-sm-8 col-xs-11">
              <form role="form" id="mc-form" action="http://csmthemes.us3.list-manage.com/subscribe/post-json?u=9666c25a337f497687875a388&amp;id=5b881a50fb&amp;c=?">
                <div class="input-group">
                  <input type="search" class="form-control" placeholder="What's your query!" required value="" name="SEARCH">
                  <span class="input-group-btn">
                  <button type="submit" class="btn btn-default" id="mc-subscribe" value="Submit" name="SUBMIT">Search <i class="fa fa-search"></i></button>
                  </span> </div>
              </form>
...
<section class="features section-spacing">
  <div class="container">
    <h2 class="text-center">EdgeBase Special Features</h2>
    <div class="row">
      <div class="col-md-6">
        <div class="wow fadeInUp product-features row">
          <div class="col-md-2 col-sm-2 col-xs-2 text-center"><i class="fa fa-keyboard-o fa-3x"></i></div>
          <div class="col-md-10 col-sm-10 col-xs-10"> 
            <!--features 3-->
            <h4>Use Plain English</h4>
            <p>You don't need to know MySQL Query syntax to use EdgeBase. Simply write and submit your queries using natural human language, i.e English language.</p>
            <!--features 3 end--> 
          </div>
        </div>
        <div class="wow fadeInUp product-features row">
          ...
          <div class="col-md-10 col-sm-10 col-xs-10">
            <!--features 4-->
            <h4>Faster Query Response</h4>
            <p>EdgeBase uses an efficient and effective query processing technique. This technique ensures that queries are processed twice (2x) the speed of traditional database system and results are displayed three (3x) times faster.</p>
            <!--features 4 end--> 
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="wow fadeInUp product-features row">
          <div class="col-md-2 col-sm-2 col-xs-2 text-center"><i class="fa fa-crosshairs fa-3x"></i></div>
          <div class="col-md-10 col-sm-10 col-xs-10"> 
            <!--features 3-->
            <h4>Accurate and 100% Response</h4>
            <p> EdgeBase makes use of all your search terms by searching through the entire database to produce data marching all your search terms. When queries fail to generate response, EdgeBase provides suggestions to improve your queries. </p>
            <!--features 3 end--> 
          </div>
        </div>
        <div class="wow fadeInUp product-features row">
          <div class="col-md-2 col-sm-2 col-xs-2 text-center"><i class="fa fa-bars fa-3x"></i></div>
          <div class="col-md-10 col-sm-10 col-xs-10">
            <!--features 4-->
            <h4>Well Organized Results</h4>
            <p>Responses generated by EdgeBase are well organized, making it easy to read.</p>
            <!--features 4 end--> 
          </div>
        </div>
      </div>
