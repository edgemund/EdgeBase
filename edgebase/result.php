    ...
    <div class="row">
      <div class="col-md-12"> 
        ...
        <header class="welcome-message text-center">
          <h1><span class="rotate">Query Response Page </span></h1>
        </header>
        <!--welcome-message end--> 
...
<!-- Advance Result Tables -->
<div id="advance_result">
<?php echo $_POST["search"]; ?><br>
...
if ($sresult->num_rows > 0) {
    echo "<div id='constrainer1'>
    		<div class='scrolltable1'>
				<table id='school' width='1000' border='1' align='center'>
					<caption>Table 1.1 Results for your query '$search'</caption>
						<thead>
...
if ($lresult->num_rows > 0) {
    echo "<div id='constrainer2'>
    		<div class='scrolltable2'>
				<table id='location' width='1000' border='1' align='center'>
					<caption>Table 1.2 Results for your query '$search'</caption>
					<thead>
					<tr><th>School Name</th>
					<th>Region</th>
					<th>District</th>
    ...
    echo "<div class='locationecho'>There were NO matches for '$search' in our locations' record. You can add names of regions, cities, towns and district to improve your search.</div>"; echo "<br>";
}
...
if ($cresult->num_rows > 0) {
    echo "<div id='constrainer2'>
    		<div class='scrolltable2'>
				<table id='contact' width='1000' border='1' align='center'>
					<caption>Table 1.3 Results for your query '$search'</caption>
						<thead>
    ...
    echo "<div class='contactecho'>There were NO matches for '$search' in our school contacts' record. You can add names of names of headteachers (first or last name), and address (location) search.</div>";
	echo "<br>";
}
$conn->close();
?></div>
